...
python ./src/plot.py -o ./tmp/experiment1/constraints-plot/ic \
    --experiment=$SCRIPT_DIR/Experiment.py --title "Initial condition for Experiment 1" \
    ic --background-diffusion
python ./src/plot.py -o ./tmp/experiment1/constraints-plot/treatment \
    --experiment=$SCRIPT_DIR/Experiment.py --title "Treatment in Experiment 1" treat
python ./src/plot.py -o ./tmp/experiment1/constraints-plot/diffusion \
